#!/usr/bin/env python3
"""
Launch file for synthetic sensor C++ node.

This launch file starts the C++ implementation of the synthetic data generator
with configuration from a YAML file. Parameters can be overridden via command line.

Usage:
    # Run with default config
    ros2 launch sensor_streamer synthetic_sensor_cpp.launch.py
    
    # Run with custom config file
    ros2 launch sensor_streamer synthetic_sensor_cpp.launch.py config_file:=config/custom_params.yaml
    
    # Override specific parameters
    ros2 launch sensor_streamer synthetic_sensor_cpp.launch.py imu_rate:=500.0 encoder_rate:=10.0
"""
...
def generate_launch_description():
    ...
    # Synthetic sensor C++ node
    synthetic_node = Node(
        package='sensor_streamer',
        executable='synthetic_sensor_node_cpp',  # C++ executable name
        name='synthetic_sensor_cpp',
        namespace=LaunchConfiguration('namespace'),
        output='screen',
